    ...
    <div className="fixed top-6 right-6 z-[200] flex flex-col gap-3 pointer-events-none">
      {activeAlerts.map(alert => {
        ...
        return (
          <div 
            key={alert.alertId}
            className={`pointer-events-auto shadow-2xl rounded-xl p-4 min-w-[280px] animate-slideInRight flex items-start gap-4 ring-1 ring-white/10 bg-paramo-card border-l-4 ${isUrgent ? 'border-orange-500' : 'border-paramo-frailejon'}`}
          >
